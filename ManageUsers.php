...
<?php include 'header.php'; ?>
	<main>
		<h1 class="slideInDown animated ">
			<section class="title flex section">
				<span><i class="fa-regular fa-circle-check"></i> Add User</span>
				<span><i class="fa-regular fa-circle-check"></i> Update User</span>
				<span><i class="fa-regular fa-circle-check"></i> Remove User</span>
			</section>
		</h1>
		<div class="title">
